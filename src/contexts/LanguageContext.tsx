...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  const translations = {
    fr: {
      ...
      'contact.service_chatbot': 'Chatbot',
      'contact.service_consulting': 'Conseil',
    ...
    en: {
      ...
      'contact.service_chatbot': 'Chatbot',
      'contact.service_consulting': 'Consulting',
    ...
    he: {
      ...
      'contact.service_chatbot': 'צ\'אטבוט',
      'contact.service_consulting': 'יעוץ',
