...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  const translations = {
    fr: {
      ...
      'contact.firstNamePlaceholder': 'Ex: Jean',
      'contact.lastName': 'Nom',
      'contact.lastNamePlaceholder': 'Ex: Dupont',
      'contact.email': 'Email',
      'contact.email_placeholder': 'votre.nom@entreprise.com',
      'contact.phone': 'Téléphone',
      'contact.phone_placeholder': '+33 6 12 34 56 78',
      'contact.phoneNumber': '+33 (0)1 23 45 67 89',
      'contact.company': 'Entreprise',
      'contact.company_placeholder': 'Ex: zyFlows SARL',
      'contact.service_label': 'Service souhaité',
      'contact.service_placeholder': 'Sélectionnez un service',
      'contact.service_website': 'Site Web',
      'contact.service_automation': 'Automatisation',
      'contact.service_chatbot': 'Chatbot IA',
      'contact.service_crm': 'CRM personnalisé',
      'contact.service_consulting': 'Conseil & Stratégie',
      'contact.service_other': 'Autre',
      'contact.message': 'Message',
      'contact.message_placeholder': 'Décrivez votre projet : objectifs, délais, budget estimé...',
      'contact.location': 'Localisation',
      'contact.locationDetail': 'Paris, France & Tel Aviv, Israël',
      'contact.hours': 'Horaires',
      'contact.hoursDetail': 'Lun-Ven: 9h-18h (CET/IST)',
      ...
      'contact.recaptcha_required': 'Veuillez compléter le reCAPTCHA',
    ...
    en: {
      ...
      'contact.firstNamePlaceholder': 'e.g. John',
      'contact.lastName': 'Last Name',
      'contact.lastNamePlaceholder': 'e.g. Smith',
      'contact.email': 'Email',
      'contact.email_placeholder': 'your.name@company.com',
      'contact.phone': 'Phone',
      'contact.phone_placeholder': '+1 (555) 123-4567',
      'contact.phoneNumber': '+1 (555) 987-6543',
      'contact.company': 'Company',
      'contact.company_placeholder': 'e.g. zyFlows Inc.',
      'contact.service_label': 'Desired Service',
      'contact.service_placeholder': 'Select a service',
      'contact.service_website': 'Website',
      'contact.service_automation': 'Automation',
      'contact.service_chatbot': 'AI Chatbot',
      'contact.service_crm': 'Custom CRM',
      'contact.service_consulting': 'Consulting & Strategy',
      'contact.service_other': 'Other',
      'contact.message': 'Message',
      'contact.message_placeholder': 'Describe your project: goals, timeline, estimated budget...',
      'contact.location': 'Location',
      'contact.locationDetail': 'Paris, France & Tel Aviv, Israel',
      'contact.hours': 'Hours',
      'contact.hoursDetail': 'Mon-Fri: 9am-6pm (CET/IST)',
      'contact.send': 'Send Message',
      'contact.sending': 'Sending...',
      'contact.success': '✓ Thank you! We\'ll get back to you within 24h.',
      'contact.error': '✗ Error sending. Please try again.',
      'contact.recaptcha_required': 'Please complete the reCAPTCHA',
    ...
    he: {
      ...
      'contact.firstNamePlaceholder': 'לדוגמה: משה',
      'contact.lastName': 'שם משפחה',
      'contact.lastNamePlaceholder': 'לדוגמה: כהן',
      'contact.email': 'אימייל',
      'contact.email_placeholder': 'הדואר.שלך@חברה.com',
      'contact.phone': 'טלפון',
      'contact.phone_placeholder': '050-123-4567',
      'contact.phoneNumber': '03-123-4567',
      'contact.company': 'חברה',
      'contact.company_placeholder': 'לדוגמה: zyFlows בע״מ',
      'contact.service_label': 'שירות מבוקש',
      'contact.service_placeholder': 'בחרו שירות',
      'contact.service_website': 'אתר אינטרנט',
      'contact.service_automation': 'אוטומציה',
      'contact.service_chatbot': 'צ\'אטבוט בינה מלאכותית',
      'contact.service_crm': 'CRM מותאם אישית',
      'contact.service_consulting': 'ייעוץ ואסטרטגיה',
      'contact.service_other': 'אחר',
      'contact.message': 'הודעה',
      'contact.message_placeholder': 'תארו את הפרויקט שלכם: מטרות, לוחות זמנים, תקציב משוער...',
      'contact.location': 'מיקום',
      'contact.locationDetail': 'פריז, צרפת ותל אביב, ישראל',
      'contact.hours': 'שעות פעילות',
      'contact.hoursDetail': 'א׳-ה׳: 9:00-18:00 (CET/IST)',
      'contact.send': 'שלחו הודעה',
      'contact.sending': 'שולח...',
      'contact.success': '✓ תודה! ניצור איתכם קשר תוך 24 שעות.',
      'contact.error': '✗ שגיאה בשליחה. אנא נסו שוב.',
      'contact.recaptcha_required': 'אנא השלימו את אימות reCAPTCHA',
